...
/**
 * Variable to receive characters from the debug system.
 * Starting from CMSIS version 1.3.0 a new ITM based support for the debug system was introduced.
 * This global variable is used by the ITM_ReceiveChar and ITM_CheckChar function in order to
 * implement a communication channel from the Debugging System to the Microcontroller System.
 *
 * See the <em>CMSIS debug support</em> documentation for more information.
 */
