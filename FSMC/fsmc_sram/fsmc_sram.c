...
/*    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2 | GPIO_Pin_3 |GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6;
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_2 | GPIO_Pin_3 |
                                  GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_6| GPIO_Pin_12 | GPIO_Pin_13 |
...
void FSMC_SRAM_WriteWord(u16 word, u32 WriteAddr)
{
    *(u16 *) (Bank1_SRAM3_ADDR + WriteAddr) = word;
}
void FSMC_SRAM_ReadWord(u16 * word, u32 ReadAddr)
{
    *word = *(vu16*) (Bank1_SRAM3_ADDR + ReadAddr);
}
